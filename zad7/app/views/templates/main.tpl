...
<head>
    ...
    <!--[if lte IE 8]>
        <link rel="stylesheet" href="{$conf->app_url}/assets/css/main-grid-old-ie.css">
    <![endif]-->
    <!--[if gt IE 8]><!-->
    ...
    <!--[if lte IE 8]>
        <link rel="stylesheet" href="{$conf->app_url}/assets/css/layouts/marketing-old-ie.css">
    <![endif]-->
    <!--[if gt IE 8]><!-->
        <link rel="stylesheet" href="{$conf->app_url}/assets/css/layouts/marketing.css">
    <!--<![endif]-->
...
{/if}
	...
	<script src="{$conf->app_url}/assets/js/softscroll.js"></script>
